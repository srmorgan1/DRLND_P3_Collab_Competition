...
class Agent:
    ...
    def __init__(self, state_size, action_size, agent_number=None, random_seed=0, gamma=0.99, tau=1e-2,
                 epsilon_start=1.0, epsilon_end=0.01, epsilon_decay=0.997, weight_decay=0, replay_buffer_size=int(1e5),
                 batch_size=128, lr_actor=5e-4, lr_critic=1e-3):
